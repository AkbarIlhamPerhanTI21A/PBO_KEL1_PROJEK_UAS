    ...
    private static void kelolaMatkul() throws SQLException {
        ...
        switch (input) {
            ...
            case 3: {
                ...
                matkul.setNama(scanner.nextLine());
                if (matkul.delete()) {
                    System.out.print("Berhasil Hapus Matkul");
                } else {
        ...
        switch (input) {
            ...
            case 4: {
                ...
                for (int i = 0; i < daftar.size(); i++) {
                    ...
                    System.out.println(i + 1 +  "  ID Ujian:" + ujian.getIdUjian()+  "  Nama Mahasiswa :" + ujian.getNamaMahasiswa() + "  Nama Matkul :" + ujian.getNamaMatkul() + "  Nama Dosen : " + ujian.getNamaDosen()+ "  Nilai :  " + ujian.getNilai());
                }
            }
