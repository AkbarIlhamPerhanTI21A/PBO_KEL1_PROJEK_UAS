...
public class TeknikInformatika {
    ...
    private static void kelolaMatkul() throws SQLException {
        ...
        switch (input) {
            ...
            case 2: {
                Matkul matkul = new Matkul();
                System.out.println("Masukan Nama Matkul Lama :");
                String matkulLama = scanner.nextLine();
                System.out.print("Masukan Nama Matkul Baru :");
                matkul.setNama(scanner.nextLine());
                if (matkul.update(matkulLama)) {
                    System.out.println("Behasil Edit Matkul");

                } else {
                    System.out.println("Gagal Edit Matkul");
                }
    ...
    private static void kelolaDosen() throws SQLException {
        ...
        switch (input) {
            case 1: {
                ...
                System.out.println("Masukan NID Dosen : ");
            ...
            case 3: {
                Dosen dosen = new Dosen();
                System.out.println("Masukan NID :");
                dosen.setNid(scanner.nextLine());
                if (dosen.delete()) {
    ...
    private static void kelolaUjian() throws SQLException {
        ...
        switch (input) {
            ...
            case 2: {
                Ujian ujian = new Ujian();
                System.out.println("Masukan ID Ujian");
            ...
            case 4: {
                ...
                for (int i = 0; i < daftar.size(); i++) {
                    ...
                    System.out.println(i + 1 + " " + ujian.getNamaMahasiswa() + " - " + ujian.getNamaMatkul() + " - " + ujian.getNamaMahasiswa() + " - " + ujian.getNilai());
                }
            }
